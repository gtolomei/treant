...
PYTHON_SCRIPT_NAME="python3 -B ./train_robust_forest_wine.py"
DATASET_NAME=wine
DATASET_DIR=../data
OUTPUT_ROOT_DIR=../out
...
count=`ls -1 ./train_robust_forest_wine.log 2>/dev/null | wc -l`
if [ $count != 0 ]
then 
    echo "==> Cleaning up log files..."
    echo "rm ./train_robust_forest_wine.log"
    rm ./train_robust_forest_wine.log
fi 
